...
This is useful for doing regular version control and rollback stuff, but in an AIey world, you can ask it to describe the diff between two versions. _"What has changed between today's version and the version we had 2 weeks ago?"_

It also allows for branching etc. (This doesn't explicitly support branch switching, but once you've figured out git, it's a thing you can do for yourself.)
